...
#Added two If Statements, otherwise num divisable by 5 and 10 will generate coding + Coding Dojo 
...
#as the range ends before highNum (aka end number is not inclusive) thus we add one. 
